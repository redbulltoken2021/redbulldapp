const IMAGE_URL = "/images/assets-1.png";
...
class ImageParticleSystem {
  ...
  _setup() {
    ...
    document.getElementById("canvas-box").appendChild(this.renderer.view);
  }
  ...
  _createParticles() {
    ...
    const imageScale = min(
      (targetImage.width - PADDING * 2) / imageWidth,
      (targetImage.height - PADDING * 2) / imageHeight
    );
